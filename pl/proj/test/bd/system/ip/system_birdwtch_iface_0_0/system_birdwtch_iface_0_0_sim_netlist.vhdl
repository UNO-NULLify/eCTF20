...
-- Date        : Fri Feb 21 17:58:59 2020
-- Host        : ssg0 running 64-bit Arch Linux
-- Command     : write_vhdl -force -mode funcsim
--               /ectf/pl/proj/test/bd/system/ip/system_birdwtch_iface_0_0/system_birdwtch_iface_0_0_sim_netlist.vhdl
...
entity system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S00_AXI is
  port (
    s00_axi_bvalid : out STD_LOGIC;
    s00_axi_wready : out STD_LOGIC;
    s00_axi_awready : out STD_LOGIC;
    s00_axi_arready : out STD_LOGIC;
    w_cmd_stb : out STD_LOGIC;
    Q : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S00_AXI : entity is "birdwtch_iface_v1_0_S00_AXI";
end system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S00_AXI;

architecture STRUCTURE of system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S00_AXI is
  signal \^q\ : STD_LOGIC;
  ...
  signal \o_cr_data[0]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[1]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[2]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[3]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[4]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[5]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[6]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[7]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_data[7]_i_2_n_0\ : STD_LOGIC;
  signal \o_cr_data[7]_i_3_n_0\ : STD_LOGIC;
  ...
  signal w_cmd_stb_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \o_cr_command[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_cr_command[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_cr_command[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_cr_command[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_cr_command[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_cr_command[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_cr_command[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_cr_command[7]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \o_cr_data[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_cr_data[7]_i_2\ : label is "soft_lutpair3";
begin
  Q <= \^q\;
...
\o_cr_command[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A808"
    )
        port map (
      I0 => \o_cr_data[7]_i_3_n_0\,
      I1 => pre_wstrb(3),
      I2 => \^s00_axi_wready\,
      I3 => s00_axi_wstrb(1),
      O => \o_cr_command[7]_i_1_n_0\
    );
\o_cr_command[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\o_cr_data[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"45400000"
    )
        port map (
...
\o_cr_data[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
w_cmd_stb_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
w_cmd_stb_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => w_cmd_stb_i_1_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S01_AXI is
  port (
    i_int_ack : out STD_LOGIC;
    ...
    int_mb : in STD_LOGIC;
    w_cmd_stb : in STD_LOGIC;
    \o_cr_command_reg[7]\ : in STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S01_AXI : entity is "birdwtch_iface_v1_0_S01_AXI";
end system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S01_AXI;

architecture STRUCTURE of system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S01_AXI is
  ...
  signal \o_cr_resp[0]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[1]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[2]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[3]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[4]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[5]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[6]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[7]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_resp[7]_i_2_n_0\ : STD_LOGIC;
  signal \o_cr_status[0]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[1]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[2]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[3]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[4]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[5]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[6]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[7]_i_1_n_0\ : STD_LOGIC;
  signal \o_cr_status[7]_i_2_n_0\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[0]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[10]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[11]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[12]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[13]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[14]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[15]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[1]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[2]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[3]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[4]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[5]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[6]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[7]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[8]\ : STD_LOGIC;
  signal \pre_wdata_reg_n_0_[9]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \o_cr_resp[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \o_cr_resp[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \o_cr_resp[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \o_cr_resp[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \o_cr_resp[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \o_cr_resp[5]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \o_cr_resp[6]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \o_cr_resp[7]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \o_cr_status[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_cr_status[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_cr_status[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_cr_status[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_cr_status[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_cr_status[5]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_cr_status[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \o_cr_status[7]_i_2\ : label is "soft_lutpair11";
begin
...
int_mb_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00EA"
    )
        port map (
...
\o_cr_resp[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
        ...
        port map (
      I0 => s01_axi_wdata(15),
      I1 => \pre_wdata_reg_n_0_[15]\,
      I2 => \^s01_axi_wready\,
      O => \o_cr_resp[7]_i_2_n_0\
    );
\o_cr_resp[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DD0D"
    )
        port map (
...
o_int_ack_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_birdwtch_iface_0_0_birdwtch is
  port (
    s00_axi_awready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_birdwtch_iface_0_0_birdwtch : entity is "birdwtch";
end system_birdwtch_iface_0_0_birdwtch;

architecture STRUCTURE of system_birdwtch_iface_0_0_birdwtch is
  signal birdwtch_iface_v1_0_S01_AXI_inst_n_3 : STD_LOGIC;
  signal birdwtch_iface_v1_0_S01_AXI_inst_n_7 : STD_LOGIC;
  signal i_int_ack : STD_LOGIC;
  signal \^int_mb\ : STD_LOGIC;
  signal o_cr_command : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal o_cr_data : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal o_cr_resp : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal o_cr_status : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal w_cmd_stb : STD_LOGIC;
  signal w_cr_status : STD_LOGIC_VECTOR ( 7 to 7 );
begin
  int_mb <= \^int_mb\;
birdwtch_iface_v1_0_S00_AXI_inst: entity work.system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S00_AXI
     port map (
      D(15) => w_cr_status(7),
      D(14 downto 8) => o_cr_status(6 downto 0),
      D(7 downto 0) => o_cr_resp(7 downto 0),
      Q => S00_AXI_RVALID,
      SR => birdwtch_iface_v1_0_S01_AXI_inst_n_3,
      \axi_rdata_reg[31]\(15 downto 8) => o_cr_command(7 downto 0),
      \axi_rdata_reg[31]\(7 downto 0) => o_cr_data(7 downto 0),
      i_int_ack => i_int_ack,
...
birdwtch_iface_v1_0_S01_AXI_inst: entity work.system_birdwtch_iface_0_0_birdwtch_iface_v1_0_S01_AXI
     port map (
      D(15) => w_cr_status(7),
      D(14 downto 8) => o_cr_status(6 downto 0),
      D(7 downto 0) => o_cr_resp(7 downto 0),
      ...
      \o_cr_command_reg[7]\(15 downto 8) => o_cr_command(7 downto 0),
      \o_cr_command_reg[7]\(7 downto 0) => o_cr_data(7 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      s01_axi_arready => s01_axi_arready,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_birdwtch_iface_0_0_birdwtch_iface_v1_0 is
  port (
    s00_axi_awready : out STD_LOGIC;
    s00_axi_wready : out STD_LOGIC;
    s00_axi_bvalid : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_birdwtch_iface_0_0_birdwtch_iface_v1_0 : entity is "birdwtch_iface_v1_0";
end system_birdwtch_iface_0_0_birdwtch_iface_v1_0;

architecture STRUCTURE of system_birdwtch_iface_0_0_birdwtch_iface_v1_0 is
begin
birdwtch_inst: entity work.system_birdwtch_iface_0_0_birdwtch
     port map (
      E(0) => s00_axi_wready,
      S00_AXI_RVALID => Q,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_birdwtch_iface_0_0 is
  port (
    int_mb : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of system_birdwtch_iface_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_birdwtch_iface_0_0 : entity is "system_birdwtch_iface_0_0,birdwtch_iface_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_birdwtch_iface_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_birdwtch_iface_0_0 : entity is "birdwtch_iface_v1_0,Vivado 2017.4";
end system_birdwtch_iface_0_0;

architecture STRUCTURE of system_birdwtch_iface_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME s00_axi_aclk, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 1e+08, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0";
  ...
  attribute X_INTERFACE_PARAMETER of s01_axi_aclk : signal is "XIL_INTERFACENAME s01_axi_aclk, ASSOCIATED_BUSIF s01_axi, ASSOCIATED_RESET s01_axi_aresetn, FREQ_HZ 1e+08, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0";
...
inst: entity work.system_birdwtch_iface_0_0_birdwtch_iface_v1_0
     port map (
      Q => s00_axi_rvalid,
      int_mb => int_mb,
      s00_axi_aclk => s00_axi_aclk,
