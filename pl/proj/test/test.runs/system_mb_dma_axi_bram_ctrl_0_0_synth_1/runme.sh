...
HD_PWD='/ectf_master/pl/proj/test/test.runs/system_mb_dma_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mb_dma_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mb_dma_axi_bram_ctrl_0_0.tcl
