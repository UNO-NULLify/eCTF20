...
HD_PWD='/ectf_master/pl/proj/test/test.runs/system_auto_pc_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_pc_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_pc_8.tcl
