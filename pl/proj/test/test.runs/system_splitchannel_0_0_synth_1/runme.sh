...
HD_PWD='/ectf/pl/proj/test/test.runs/system_splitchannel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_splitchannel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_splitchannel_0_0.tcl
