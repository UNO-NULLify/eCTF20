...
HD_PWD='/ectf_dev/ectf/eCTF20/pl/proj/test/test.runs/system_mdm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mdm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mdm_0_0.tcl
