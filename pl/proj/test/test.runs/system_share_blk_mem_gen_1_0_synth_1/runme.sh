...
HD_PWD='/ectf/pl/proj/test/test.runs/system_share_blk_mem_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_share_blk_mem_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_share_blk_mem_gen_1_0.tcl
