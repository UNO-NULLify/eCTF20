...
HD_PWD='/ectf/pl/proj/test/test.runs/system_xlconcat_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconcat_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconcat_2_0.tcl
