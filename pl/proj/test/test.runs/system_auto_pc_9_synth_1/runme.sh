...
HD_PWD='/ectf_dev/ectf/eCTF20/pl/proj/test/test.runs/system_auto_pc_9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_pc_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_pc_9.tcl
