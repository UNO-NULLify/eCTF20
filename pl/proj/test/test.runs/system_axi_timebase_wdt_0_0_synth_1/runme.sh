...
HD_PWD='C:/Users/Benjamin/Downloads/eCTF20-datapath-changes-edit/eCTF20-datapath-changes/pl/proj/test/test.runs/system_axi_timebase_wdt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_timebase_wdt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_timebase_wdt_0_0.tcl
