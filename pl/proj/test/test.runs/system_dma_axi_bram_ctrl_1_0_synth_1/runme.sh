...
HD_PWD='/ectf_master/pl/proj/test/test.runs/system_dma_axi_bram_ctrl_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_dma_axi_bram_ctrl_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_dma_axi_bram_ctrl_1_0.tcl
