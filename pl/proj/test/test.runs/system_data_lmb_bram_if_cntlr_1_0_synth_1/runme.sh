...
HD_PWD='/ectf_master/pl/proj/test/test.runs/system_data_lmb_bram_if_cntlr_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_data_lmb_bram_if_cntlr_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_data_lmb_bram_if_cntlr_1_0.tcl
