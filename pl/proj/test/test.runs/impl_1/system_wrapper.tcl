...
set rc [catch {
  ...
  add_files /ectf/pl/src/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf
  set_property SCOPED_TO_REF system [get_files -all /ectf/pl/src/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
  set_property SCOPED_TO_CELLS microblaze_0 [get_files -all /ectf/pl/src/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
