...
HD_PWD='/ectf_master/pl/proj/test/test.runs/system_clk_wiz_25M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_clk_wiz_25M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_clk_wiz_25M_0.tcl
