...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_birdwtch_iface_v1_0_S00_AXI is
  ...
  signal int_mb_i_2_n_0 : STD_LOGIC;
  signal int_mb_i_3_n_0 : STD_LOGIC;
  ...
  signal \write_response_stall__1\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \o_cr_command[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_cr_command[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_cr_command[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_cr_command[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_cr_command[6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_cr_command[7]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_cr_data[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_cr_data[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_cr_data[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_cr_data[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_cr_data[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_cr_data[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_cr_data[6]_i_1\ : label is "soft_lutpair5";
...
int_mb_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000BFAA"
    )
        port map (
...
int_mb_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
int_mb_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_birdwtch_iface_v1_0_S01_AXI is
  ...
  signal \o_cr_resp[7]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \o_cr_resp[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_cr_resp[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_cr_resp[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_cr_resp[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_cr_resp[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_cr_resp[7]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_cr_status[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \o_cr_status[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \o_cr_status[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \o_cr_status[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \o_cr_status[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \o_cr_status[5]_i_1\ : label is "soft_lutpair13";
...
\o_cr_resp[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"88C0"
    )
        port map (
...
\o_cr_resp[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\o_cr_status[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"88C0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_birdwtch is
  signal birdwtch_iface_v1_0_S00_AXI_inst_n_5 : STD_LOGIC;
...
birdwtch_iface_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_birdwtch_iface_v1_0_S00_AXI
     port map (
      ...
      int_mb => \^int_mb\,
      int_mb_reg => birdwtch_iface_v1_0_S00_AXI_inst_n_5,
...
int_mb_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => birdwtch_iface_v1_0_S00_AXI_inst_n_5,
      Q => \^int_mb\,
      R => '0'
    );
end STRUCTURE;
