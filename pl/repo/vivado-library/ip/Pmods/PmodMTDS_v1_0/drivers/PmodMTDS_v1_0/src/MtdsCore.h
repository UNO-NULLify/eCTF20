 ...
 */
/*																				*/
/*	This header file contains declarations for MtdsUtil.c. This module
 * contains	*/
/*	miscellaneous support functions for the Digilent Multi-Touch Display
 * Shield	*/
 ...
 */
/*		new file MtdsHal.h as part of the definition of a hardware
 * abstraction	*/
...
#define tmsResumeTimeout                                                       \
  1000 // time to wait for shield to return to idle state on resume
#define tmsUpdateTimeout                                                       \
  5000 // time to wait for shield to begin firmware update
...
#define cbRetValInit                                                           \
  (sizeof(RHDR) + cbRhdrDataMax) // size of status packet buffer
