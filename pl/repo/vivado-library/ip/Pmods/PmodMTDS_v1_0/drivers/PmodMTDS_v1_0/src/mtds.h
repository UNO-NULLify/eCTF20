/********************************************************************************/
/*																				*/
/*	mtds.h	--	Digilent Multi-Touch Display Shield Library
 * Declarations		*/
/*																				*/
/********************************************************************************/
...
protected:
  ...
  void MtdsProcessCmdWr(uint8_t cls, uint8_t cmd, uint16_t cbParam,
                        uint8_t *pbParam, uint16_t cbData, uint8_t *pbData);
  void MtdsProcessCmdRd(uint8_t cls, uint8_t cmd, uint16_t cbParam,
                        uint8_t *pbParam, uint16_t cbData, uint8_t *pbData);
...
public:
  ...
  bool ReadMem(HMEM hmem, uint32_t ibRead, uint32_t cbRead, uint8_t *rgbBuf,
               uint32_t *pcbRes);
  bool WriteMem(HMEM hmem, uint32_t ibWrite, uint32_t cbWrite, uint8_t *rgbBuf,
                uint32_t *pcbRes);
  ...
  bool Arc(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
           int16_t ycoBottom, int16_t xcoRad1, int16_t ycoRad1, int16_t xcoRad2,
           int16_t ycoRad2);
  bool ArcTo(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
             int16_t ycoBottom, int16_t xcoRad1, int16_t ycoRad1,
             int16_t xcoRad2, int16_t ycoRad2);
  bool Ellipse(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
               int16_t ycoBottom);
  bool Chord(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
             int16_t ycoBottom, int16_t xcoRad1, int16_t ycoRad1,
             int16_t xcoRad2, int16_t ycoRad2);
  bool Pie(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
           int16_t ycoBottom, int16_t xcoRad1, int16_t ycoRad1, int16_t xcoRad2,
           int16_t ycoRad2);
  bool Rectangle(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
                 int16_t ycoBottom);
  bool RoundRect(HDS hds, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
  ...
  bool BitBlt(HDS hdsDst, int16_t xcoDst, int16_t ycoDst, int16_t dxco,
              int16_t dyco, HDS hdsSrc, int16_t xcoSrc, int16_t ycoSrc,
              uint16_t rop);
  bool PatBlt(HDS hdsDst, int16_t xco, int16_t yco, int16_t dxco, int16_t dyco,
              uint16_t rop);
  bool DrawBitmap(HDS hdsDst, int16_t xcoDst, int16_t ycoDst, int16_t dxco,
                  int16_t dyco, HDS hdsSrc, int16_t xcoSrc, int16_t ycoSrc);

  bool IsRectEmpty(RCT *prct);
  bool IsRectEqual(RCT *prct1, RCT *prct2);
  bool PointInRect(RCT *prct, int16_t xco, int16_t yco);
  bool PointInRect(RCT *prct, PNT pnt) {
    return PointInRect(prct, pnt.xco, pnt.yco);
  };
  void SetRectEmpty(RCT *prct);
  void SetRect(RCT *prct, int16_t xcoLeft, int16_t ycoTop, int16_t xcoRight,
               int16_t ycoBottom);
...
public:
  ...
  uint8_t GetLastError(uint8_t *pcls, uint8_t *pcmd) {
    return mtds.GetLastError(pcls, pcmd);
  };
...
public:
  ...
  uint32_t GetElapsedTime() { return mtds.GetElapsedTime(); };
  HWIN CreateWindow(HWIN hwinParent, uint16_t wcls, uint32_t wstl, int16_t xco,
                    int16_t yco, int16_t dxco, int16_t dyco);
  ...
  bool GetWindowPos(HWIN hwin, int16_t *pxco, int16_t *pyco, int16_t *pdxco,
                    int16_t *pdyco);
  bool MoveWindow(HWIN hwin, uint16_t wmv, int16_t xco, int16_t yco,
