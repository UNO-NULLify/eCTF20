...
HD_PWD='/ectf/pl/proj/ip_repo/edit_birdwtch_iface_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log birdwtch_iface_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source birdwtch_iface_v1_0.tcl
