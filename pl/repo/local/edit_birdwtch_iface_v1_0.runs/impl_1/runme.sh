...
HD_PWD='/ectf/pl/proj/ip_repo/edit_birdwtch_iface_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log birdwtch_iface_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source birdwtch_iface_v1_0.tcl -notrace
