...
int SetUpInterruptSystem(XIntc *XIntcInstancePtr, XInterruptHandler hdlr) {
   ...
   */
  Status =
      XIntc_Connect(XIntcInstancePtr, XPAR_INTC_0_DEVICE_ID, hdlr, (void *)0);
...
u32 fnAudioPlay(XAxiDma AxiDma, u32 offset, u32 u32NrSamples) {
  ...
  status = XAxiDma_SimpleTransfer(
      &AxiDma, (u32)(XPAR_MB_DMA_AXI_BRAM_CTRL_0_S_AXI_BASEADDR + offset),
      u32NrSamples, XAXIDMA_DMA_TO_DEVICE);
