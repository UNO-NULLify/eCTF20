...
int crypto_aead_aes256gcm_encrypt_afternm(
    ...
    unsigned long long mlen, const unsigned char *ad, unsigned long long adlen,
    const unsigned char *nsec, const unsigned char *npub,
    const crypto_aead_aes256gcm_state *ctx_) __attribute__((nonnull(1, 8, 9)));
...
int crypto_aead_aes256gcm_decrypt_afternm(
    ...
    const crypto_aead_aes256gcm_state *ctx_) __attribute__((warn_unused_result))
...
int crypto_aead_aes256gcm_decrypt_detached_afternm(
    ...
    unsigned long long adlen, const unsigned char *npub,
    const crypto_aead_aes256gcm_state *ctx_) __attribute__((warn_unused_result))
__attribute__((nonnull(3, 5, 8, 9)));

SODIUM_EXPORT
void crypto_aead_aes256gcm_keygen(
    unsigned char k[crypto_aead_aes256gcm_KEYBYTES]) __attribute__((nonnull));
