...
$LFE14:
$Lfe2:
	.size	is_provisioned_rid,$Lfe2-is_provisioned_rid
	.rodata
	.align	2
$LC9:
...
$LFE15:
$Lfe3:
	.size	rid_to_region_name,$Lfe3-rid_to_region_name
	.rodata
	.align	2
$LC11:
...
$LFE16:
$Lfe4:
	.size	region_name_to_rid,$Lfe4-region_name_to_rid
...
$LFE17:
$Lfe5:
	.size	is_provisioned_uid,$Lfe5-is_provisioned_uid
	.rodata
	.align	2
$LC12:
...
$LFE18:
$Lfe6:
	.size	uid_to_username,$Lfe6-uid_to_username
	.rodata
	.align	2
$LC14:
...
$LFE19:
$Lfe7:
	.size	username_to_uid,$Lfe7-username_to_uid
...
$LFE20:
$Lfe8:
	.size	load_song_md,$Lfe8-load_song_md
	.rodata
	.align	2
$LC15:
...
$LFE22:
$Lfe10:
	.size	gen_song_md,$Lfe10-gen_song_md
	.rodata
	.align	2
$LC20:
...
$LFE25:
$Lfe13:
	.size	query_player,$Lfe13-query_player
	.rodata
	.align	2
$LC27:
...
$LFE26:
$Lfe14:
	.size	query_song,$Lfe14-query_song
	.rodata
	.align	2
$LC28:
...
$LFE27:
$Lfe15:
	.size	share_song,$Lfe15-share_song
	.rodata
	.align	2
$LC32:
...
play_song:
	.frame	r19,1928,r15		# vars= 40, regs= 1, args= 1880
	.mask	0x00088000
	addik	r1,r1,-1928
$LCFI45:
	swi	r15,r1,0
...
$LM260:
	lwi	r3,r19,1888
	addik	r4,r0,16000	# 0x3e80
	cmpu	r18,r3,r4
	bgei	r18,$L105
	addik	r3,r0,16000	# 0x3e80
$L105:
	swi	r3,r19,1912
$LM261:
	lwi	r3,r0,c
...
$LM262:
	...
	lwi	r7,r19,1912
	addk	r6,r3,r0
	addik	r5,r0,-1073741824
	brlid	r15,Xil_MemCpy
	nop		# Unfilled delay slot
...
$LM270:
	...
	bri	$L111
$L110:
	lbui	r4,r3,sAxiDma+24
	sb	r4,r3,r5
	addik	r3,r3,1
$L111:
	addik	r4,r0,1848	# 0x738
	cmpu	r18,r4,r3
	blti	r18,$L110
	lwi	r5,r0,sAxiDma
	lwi	r6,r0,sAxiDma+4
	lwi	r7,r0,sAxiDma+8
	lwi	r8,r0,sAxiDma+12
	lwi	r9,r0,sAxiDma+16
	lwi	r10,r0,sAxiDma+20
	brlid	r15,fnAudioPlay
	nop		# Unfilled delay slot
...
$LFE28:
$Lfe16:
	.size	play_song,$Lfe16-play_song
	.rodata
	.align	2
$LC40:
...
$LFE29:
$Lfe17:
	.size	digital_out,$Lfe17-digital_out
	.rodata
	.align	2
$LC43:
...
$LC44:
	...
	.align	2
$LC45:
	.ascii "\15\12MB> Command reg: %08X\15\12\0"
	.align	2
$LC46:
...
$Ldebug_macro24:
	...
	.4byte	$LASF667
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.xparameters.h.2.dcd16d2842f599e0ac2d2d32912fd70a,comdat
$Ldebug_macro25:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
$Ldebug_macro49:
	...
	.4byte	$LASF2066
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.constants.h.7.3f3994903d596d074a1b6f343219d4a8,comdat
$Ldebug_macro50:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
$Ldebug_macro52:
	...
	.4byte	$LASF2118
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.math.h.36.34d5f8ee70c9ac4f2bc14da406a89218,comdat
$Ldebug_macro53:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
$LASF2143:
	.ascii "isnormal(__x) (__builtin_isnormal (__x))\0"
$LASF2159:
	.ascii "PLOSS 6\0"
$LASF956:
...
$LASF2141:
	.ascii "isinf(__x) (__builtin_isinf_sign (__x))\0"
$LASF707:
	.ascii "XPAR_MICROBLAZE_0_DEBUG_TRACE_SIZE 8192\0"
$LASF264:
	.ascii "_READ_WRITE_BUFSIZE_TYPE int\0"
$LASF1034:
	.ascii "XPAR_MICROBLAZE_NUMBER_OF_RD_ADDR_BRK 2\0"
$LASF1579:
...
$LASF2194:
	.ascii "NSEEKSAMPLES (48000 * 5 * 2)\0"
$LASF1396:
...
$LASF2146:
	.ascii "isgreaterequal(__x,__y) (__builtin_isgreaterequal (__x, __y))\0"
$LASF302:
...
$LASF290:
	.ascii "_FSTDIO \0"
$LASF672:
	.ascii "XPAR_PROC_BUS_1_FREQ_HZ 1e+08\0"
$LASF2447:
	.ascii "__fdlibm_svid\0"
$LASF2271:
	.ascii "_sig_func\0"
$LASF626:
...
$LASF2149:
	.ascii "islessgreater(__x,__y) (__builtin_islessgreater (__x, __y))\0"
$LASF2376:
...
$LASF2148:
	.ascii "islessequal(__x,__y) (__builtin_islessequal (__x, __y))\0"
$LASF2227:
	.ascii "__tm\0"
$LASF2089:
	.ascii "NUM_REGIONS 3\0"
$LASF2140:
	.ascii "isfinite(__x) (__builtin_isfinite (__x))\0"
$LASF637:
...
$LASF2139:
	.ascii "fpclassify(__x) (__builtin_fpclassify (FP_NAN, FP_INFINITE, FP_NORMAL, FP_SUBNORMAL, FP_ZERO, __x))\0"
$LASF2104:
...
$LASF676:
	.ascii "XPAR_MICROBLAZE_0_ADDR_TAG_BITS 17\0"
$LASF1572:
...
$LASF1099:
	.ascii "XPAR_MICROBLAZE_USE_HW_MUL 0\0"
$LASF2225:
	.ascii "_wds\0"
$LASF70:
...
$LASF814:
	.ascii "XPAR_MICROBLAZE_0_NUMBER_OF_RD_ADDR_BRK 2\0"
$LASF1004:
...
$LASF2335:
	.ascii "IsRxChannel\0"
$LASF908:
	.ascii "XPAR_MICROBLAZE_DCACHE_ADDR_TAG 17\0"
$LASF2101:
...
$LASF1094:
	.ascii "XPAR_MICROBLAZE_USE_DIV 0\0"
$LASF227:
...
$LASF673:
	.ascii "XPAR_CPU_CORE_CLOCK_FREQ_HZ 1e+08\0"
$LASF750:
...
$LASF2356:
	.ascii "HwCnt\0"
$LASF1033:
	.ascii "XPAR_MICROBLAZE_NUMBER_OF_PC_BRK 4\0"
$LASF1162:
...
$LASF1035:
	.ascii "XPAR_MICROBLAZE_NUMBER_OF_WR_ADDR_BRK 2\0"
$LASF858:
...
$LASF2145:
	.ascii "isgreater(__x,__y) (__builtin_isgreater (__x, __y))\0"
$LASF2067:
...
$LASF2142:
	.ascii "isnan(__x) (__builtin_isnan (__x))\0"
$LASF1346:
...
$LASF1341:
	.ascii "XPAR_AXI_INTC_0_INT_AXI_GPIO_0_GPIO_IO_O_INTR 0U\0"
$LASF1166:
...
$LASF874:
	.ascii "XPAR_MICROBLAZE_0_USE_DIV 0\0"
$LASF1663:
...
$LASF2144:
	.ascii "signbit(__x) ((sizeof(__x) == sizeof(float)) ? __builtin_signbitf(__x) : (sizeof(__x) == sizeof(double)) ? __builtin_signbit (__x) : __builtin_signbitl(__x))\0"
$LASF687:
...
$LASF815:
	.ascii "XPAR_MICROBLAZE_0_NUMBER_OF_WR_ADDR_BRK 2\0"
$LASF894:
...
$LASF2223:
	.ascii "_maxwds\0"
$LASF1090:
	.ascii "XPAR_MICROBLAZE_USE_BARREL 0\0"
$LASF1161:
...
$LASF669:
	.ascii "XPAR_CPU_M_AXI_DP_FREQ_HZ 1e+08\0"
$LASF1957:
...
$LASF2319:
	.ascii "_impure_ptr\0"
$LASF670:
	.ascii "XPAR_CPU_M_AXI_IP_FREQ_HZ 1e+08\0"
$LASF621:
...
$LASF688:
	.ascii "XPAR_MICROBLAZE_0_DCACHE_ADDR_TAG 17\0"
$LASF279:
...
$LASF879:
	.ascii "XPAR_MICROBLAZE_0_USE_HW_MUL 0\0"
$LASF2014:
...
$LASF671:
	.ascii "XPAR_PROC_BUS_0_FREQ_HZ 1e+08\0"
$LASF2379:
...
$LASF630:
	.ascii "_IOLBF 1\0"
$LASF896:
	.ascii "XPAR_MICROBLAZE_ADDR_TAG_BITS 17\0"
$LASF1225:
...
$LASF674:
	.ascii "XPAR_MICROBLAZE_CORE_CLOCK_FREQ_HZ 1e+08\0"
$LASF175:
...
$LASF813:
	.ascii "XPAR_MICROBLAZE_0_NUMBER_OF_PC_BRK 4\0"
$LASF2132:
...
$LASF1340:
	.ascii "XPAR_INT_AXI_GPIO_0_GPIO_IO_O_MASK 0X000001U\0"
$LASF1529:
	.ascii "XNULL NULL\0"
$LASF14:
...
$LASF2147:
	.ascii "isless(__x,__y) (__builtin_isless (__x, __y))\0"
$LASF55:
...
$LASF870:
	.ascii "XPAR_MICROBLAZE_0_USE_BARREL 0\0"
$LASF937:
...
$LASF2150:
	.ascii "isunordered(__x,__y) (__builtin_isunordered (__x, __y))\0"
$LASF945:
