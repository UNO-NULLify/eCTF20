...
# 55 "/ectf/mb/drm_audio_fw_bsp/microblaze_0/include/xstatus.h" 2
...
# 18 "/opt/Xilinx/SDK/2017.4/gnu/microblaze/lin/microblaze-xilinx-elf/include/newlib.h" 3
...
# 5 "/opt/Xilinx/SDK/2017.4/gnu/microblaze/lin/microblaze-xilinx-elf/include/ctype.h" 2 3
...
# 6 "/opt/Xilinx/SDK/2017.4/gnu/microblaze/lin/microblaze-xilinx-elf/include/ctype.h" 2 3
...
# 12 "/opt/Xilinx/SDK/2017.4/gnu/microblaze/lin/microblaze-xilinx-elf/include/string.h" 2 3
...
# 1 "/ectf/mb/drm_audio_fw_bsp/microblaze_0/include/PWM.h" 1
...
# 33 "/ectf/mb/drm_audio_fw_bsp/microblaze_0/include/PWM.h"
#define PWM_mWriteReg(BaseAddress,RegOffset,Data) Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
# 53 "/ectf/mb/drm_audio_fw_bsp/microblaze_0/include/PWM.h"
#define PWM_mReadReg(BaseAddress,RegOffset) Xil_In32((BaseAddress) + (RegOffset))
# 76 "/ectf/mb/drm_audio_fw_bsp/microblaze_0/include/PWM.h"
...
int SetUpInterruptSystem(XIntc *XIntcInstancePtr, XInterruptHandler hdlr)
{
 ...
 Status = XIntc_Connect(XIntcInstancePtr, 0,
        hdlr,
       (void *)0);
 if (Status != 0L) {
  return 1L;
...
# 62 "../src/util.c"
 Status = XIntc_Start(XIntcInstancePtr, 1);
 if (Status != 0L) {
  return 1L;
 }
 ...
 XIntc_Enable(XIntcInstancePtr, 0);
 ...
 Xil_ExceptionRegisterHandler(16U,
...
u32 fnAudioPlay(XAxiDma AxiDma, u32 offset, u32 u32NrSamples)
{
 ...
 status = XAxiDma_SimpleTransfer(&AxiDma,(u32) (0xC0000000U + offset), u32NrSamples, 0x00);
...
XStatus fnConfigDma(XAxiDma *AxiDma)
{
 ...
 pCfgPtr = XAxiDma_LookupConfig(0);
 if (!pCfgPtr)
 {
