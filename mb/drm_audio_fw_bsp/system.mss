...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.2
 PARAMETER HW_INSTANCE = mb_dma_axi_bram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.2
 PARAMETER HW_INSTANCE = share_axi_bram_ctrl_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fifo_count_axi_gpio_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = birdwtch_iface
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = birdwtch_iface_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axis_data_fifo_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = clk_wiz
 PARAMETER DRIVER_VER = 1.2
 PARAMETER HW_INSTANCE = clk_wiz_25M
END
