 ...
 * connected to the MicroBlaze Fast Simplex Link (FSL) Interfaces.To use these
 *functions, include the header file fsl.h in your source code
 *
 * @{
 *
 ******************************************************************************/
...
@param val    literal in the range of 0 to 7 (0 to 15 for MicroBlaze v7.00.a and
later)
